...
The first time a user passes a given lesson, the system SHALL increment that lesson's theme skill counter for that user by 1.
...
- **THEN** the system does not increment the theme skill value again for that lesson
