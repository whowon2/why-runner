...
Defines the user-facing theme customization capability for WhyRunner: a `/settings` Appearance section where authenticated users can pick a preset theme or build a custom color-token theme, applied live client-side and persisted across reloads.
