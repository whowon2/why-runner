...
Defines the follow/unfollow relationship between users, self-follow prevention, follower/following counts and state on profiles, and dedicated followers/following list pages with search.
