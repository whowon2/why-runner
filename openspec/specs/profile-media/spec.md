...
Lets an authenticated user upload and crop their profile avatar and cover image on the profile settings page, with server-side re-processing/validation and fallback display when no cover is set.
