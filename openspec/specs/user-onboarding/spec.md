...
Defines the post-signup onboarding gate: new users must set a unique `username` before accessing the rest of the app, tracked via a `finishedOnboarding` flag.
