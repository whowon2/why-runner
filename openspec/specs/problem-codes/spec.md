...
Defines the `code` identifier assigned to every problem at creation: a short, unique, alphanumeric, immutable identifier used to disambiguate problems (e.g. when titles collide) wherever problems are listed for selection.
