...
export default function Home() {
  ...
  return (
    <main className="flex flex-col items-center justify-center flex-1 w-full overflow-hidden relative">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-4xl h-[40rem] bg-indigo-500/10 blur-[120px] rounded-none mix-blend-multiply pointer-events-none dark:bg-indigo-500/20" />
      ...
      <section className="relative flex flex-col items-center justify-center px-4 h-screen min-h-[800px] w-full  text-center -mt-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-10 animate-in fade-in slide-in-from-bottom-10 duration-700 delay-500">
          <Link href="contests">
            <Button
              size="lg"
              className="rounded-none px-8 h-12 text-base font-semibold shadow-[0_0_40px_-10px_rgba(99,102,241,0.5)] transition-all hover:scale-105 hover:shadow-[0_0_60px_-10px_rgba(99,102,241,0.6)]"
            >
              {t("buttons.contests")}
            </Button>
          </Link>
          <Link href="problems">
            <Button
              variant="outline"
              size="lg"
              className="rounded-none px-8 h-12 text-base font-semibold hover:bg-muted/50 backdrop-blur-md border-border/50 transition-all hover:scale-105"
            >
              {t("buttons.problems")}
            </Button>
          </Link>
      ...
      {/* Safari Preview */}
      <section
        className="w-full max-w-5xl px-4 text-center mt-10 space-y-8 relative "
        id="example"
      >
      ...
      {/* Features */}
      <section className="w-full max-w-5xl px-4 text-center mt-40 space-y-16 relative ">
        <div className="space-y-4 max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="bg-background/40 backdrop-blur-md border-border/50 hover:border-indigo-500/50 transition-colors shadow-sm hover:shadow-md text-left group">
            <CardContent className="p-8 space-y-4">
              <div className="h-12 w-12 rounded-none bg-indigo-500/10 flex items-center justify-center group-hover:bg-indigo-500/20 transition-colors">
          ...
          <Card className="bg-background/40 backdrop-blur-md border-border/50 hover:border-purple-500/50 transition-colors shadow-sm hover:shadow-md text-left group">
            <CardContent className="p-8 space-y-4">
              <div className="h-12 w-12 rounded-none bg-purple-500/10 flex items-center justify-center group-hover:bg-purple-500/20 transition-colors">
          ...
          <Card className="bg-background/40 backdrop-blur-md border-border/50 hover:border-cyan-500/50 transition-colors shadow-sm hover:shadow-md text-left group">
            <CardContent className="p-8 space-y-4">
              <div className="h-12 w-12 rounded-none bg-cyan-500/10 flex items-center justify-center group-hover:bg-cyan-500/20 transition-colors">
      ...
      {/* How It Works */}
      <section className="w-full max-w-5xl px-4 mt-40 space-y-16 relative ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          ...
          {[
            ...
            >
              <div className="h-14 w-14 rounded-none bg-background border-4 border-indigo-500 flex items-center justify-center font-bold text-xl shadow-[0_0_20px_-5px_rgba(99,102,241,0.5)] ">
                {item.step}
              </div>
      ...
      {/* Tech Stack */}
      <section className="w-full max-w-5xl px-4 text-center mt-40 mb-32 space-y-8 relative ">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          {[
            ...
            <div
              key={tech}
              className="px-4 py-2 rounded-none border bg-background/50 backdrop-blur-sm text-sm font-medium text-muted-foreground hover:text-foreground hover:border-foreground/30 transition-colors cursor-default"
            >
              {tech}
            </div>
          ))}
