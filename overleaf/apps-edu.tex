...
\begin{itemize}[nosep]
  ...
  \item \textbf{Notificações}: caixa de entrada in-app (follow, curtida,
        comentário, submissão avaliada, pedido/aprovação de entrada em
        competição, aula desbloqueada), com contagem de não lidas e
        agregação de eventos repetidos do mesmo tipo;
